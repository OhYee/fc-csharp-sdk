...
namespace Aliyun.FunctionCompute.SDK.Constants
{
    public static class Const
    {
        ...
        public static readonly string INSTACE_PATH = SINGLE_INSTANCE_PATH + "/{4}}";
        public static readonly string SINGLE_INSTANCE_EXEC_PATH = INSTACE_PATH + "/{5}";
        ...
        public static readonly string RESERVED_CAPACITY_PATH = "/{0}/reservedCapacities";
        ...
        public static readonly string SINGLE_WITH_QUALIFIER_INSTANCE_EXEC_PATH = INSTACE_WITH_QUALIFIER_PATH + "/{5}";
